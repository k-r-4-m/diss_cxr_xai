...
Given the file limits for GitHub repositories, the model checkpoints used for the evaluation results in the dissertation report are **NOT** stored in this repo.
...
The figure showing training images before and after majority voting was implemented (Figure 3.5) can be generated by running vindr_after_voting.py

The bar plots showing the original distribution of classes (Fig. 3.3), the distribution before and after voting (Fig. 3.6), and the final distribution of classes (Figure 3.7) can be generated by running vindr_classes_plot_after_voting.py
